      ...
      <div className="min-h-screen bg-white" data-testid="article-page">
        <nav className="sticky top-0 z-20 bg-white border-b px-8 lg:px-16 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center justify-center gap-2 -mt-3">
            <img src="/setu-logo.svg" alt="SETU Labs" className="h-[230px] w-auto object-contain p-3" />
          </div>
        </nav>
      ...
      <nav className="sticky top-0 z-20 bg-white border-b px-6 lg:px-12 py-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center">
            <img src="/setu-logo.svg" alt="SETU Labs" className="h-[90px] w-auto object-contain" />
          </div>
        </div>
