...
const Assessment = ({ user, apiClient }) => {
  ...
  return (
    <div className="flex min-h-screen bg-white" data-testid="assessment-page">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <header className="sticky top-0 z-20 bg-white/85 backdrop-blur-md border-b border-gray-200 px-8 lg:px-12 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5 text-xs text-gray-600">
              <div className="text-center"><p className="text-base font-bold text-gray-900">4</p><p>Calculators</p></div>
              <div className="w-px h-8 bg-gray-100" />
              <div className="text-center"><p className="text-base font-bold text-gray-900">~10</p><p>Minutes</p></div>
            </div>
          </header>
              ...
              <div className="space-y-4">
                ...
                <Card className="bg-gradient-to-br from-emerald-600/80 to-teal-700/80 backdrop-blur-xl border border-emerald-400/30">
                  <CardContent className="p-4">
                    ...
                    <h3 className="font-semibold text-sm text-gray-900 mb-2">Ready to check your eligibility?</h3>
