        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <header className="sticky top-0 z-20 bg-white/85 backdrop-blur-md border-b border-gray-200 px-8 lg:px-12 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5 text-xs text-gray-600">
              <div className="text-center"><p className="text-lg font-bold text-gray-900">4</p><p>Calculators</p></div>
              <div className="w-px h-8 bg-gray-100" />
              <div className="text-center"><p className="text-lg font-bold text-gray-900">~10</p><p>Minutes</p></div>
            </div>
          </header>
